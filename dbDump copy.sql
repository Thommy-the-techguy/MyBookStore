...
ALTER ROLE postgres WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:d5uuN3R4wgb7FdwzWEyyeg==$er9DBo4BHf8CELPTTjBmGk1ICnONTOfKdXz/U7csBDc=:yGRMfKS6YG1EcyTGlqFw2reKj73hgJ1YOrIl1MDRx90=';
...
--
-- Name: auth_server_db; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE auth_server_db WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.utf8';


ALTER DATABASE auth_server_db OWNER TO postgres;

\connect auth_server_db
...
--
-- Name: registered_clients; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: registered_clients_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.registered_clients_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.registered_clients_id_seq OWNER TO postgres;

--
-- Name: registered_clients_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.registered_clients_id_seq OWNED BY public.registered_clients.id;


--
-- Name: registered_clients id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.registered_clients ALTER COLUMN id SET DEFAULT nextval('public.registered_clients_id_seq'::regclass);


--
-- Data for Name: registered_clients; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.registered_clients (id, client_id, client_secret) FROM stdin;
\.


--
-- Name: registered_clients_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.registered_clients_id_seq', 1, false);


--
-- Name: registered_clients registered_clients_client_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.registered_clients
    ADD CONSTRAINT registered_clients_client_id_key UNIQUE (client_id);


--
-- Name: registered_clients registered_clients_client_secret_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.registered_clients
    ADD CONSTRAINT registered_clients_client_secret_key UNIQUE (client_secret);


--
-- Name: registered_clients registered_clients_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: iehelperdb; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE iehelperdb WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.utf8';


ALTER DATABASE iehelperdb OWNER TO postgres;
...
CREATE TABLE public.contractors (
    ...
    naming character varying(256) NOT NULL,
    legal_address character varying(256) NOT NULL,
    bank_details character varying(256) NOT NULL,
...
--
-- Name: users_contractors; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.users_contractors (
    id bigint NOT NULL,
    user_id integer NOT NULL,
...
ALTER TABLE public.users_contractors OWNER TO postgres;

--
-- Name: users_contractors_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.users_contractors_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.users_contractors_id_seq OWNER TO postgres;

--
-- Name: users_contractors_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.users_contractors_id_seq OWNED BY public.users_contractors.id;
...
--
-- Name: users_contractors id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.users_contractors ALTER COLUMN id SET DEFAULT nextval('public.users_contractors_id_seq'::regclass);
...
COPY public.contractors (identifier, naming, legal_address, bank_details, is_buyer) FROM stdin;
KN26478IK9	"ООО" Колосок	ул. Слонимская	БС2452728К947КН784	t
\.
...
56	qqq1	$2a$10$5Y/ylB3RYm8F4Mi9QeTnuuorEEH.lu1YLlntvq6hLo5fOlux.9FfO	USER
58	freeman	$2a$10$ZjxKxC1PUhba2QmERX5WgOnQZO8l4OJMR1bJabcpeOvechrm.S5G2	USER
59	tty	$2a$10$OsmWAms.5dTxMk3L7rdLIeaAzir.rfMO3wHwAGAE2pQXjedSET5Wi	USER
22	donaldDuck	$2a$10$w3/wtjplYa.tWZBb5wA3g.JS91PGAHtCFIvf0H2Cm9wxeCEQN2aQi	USER
23	batman	$2a$10$TO0JsUauLjh96JSy1D4TdON7zxKLpdxpvG3wzPChN9Fmk31ooyfwO	USER
24	DonaldTest	$2a$10$R/KgEDw.5nRrH4lDjdIKn.6/krO4w1BtDofq6vRQZBZO188OJvW3q	USER
51	123	$2a$10$LfWOOHpQdcKUjwjxJwffYuAIFvM6XduIeZu0UkhX3ByFJbHHbVCnG	USER
52	test	$2a$10$qWhbxE8fuMA22pcpOOXByeiisVKtOcY0byXQr.s9VcMBVCe9ITC1e	USER
\.


--
-- Data for Name: users_contractors; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.users_contractors (id, user_id, contractor_id) FROM stdin;
1	59	KN26478IK9
\.


--
-- Name: users_contractors_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.users_contractors_id_seq', 1, true);
...
--
-- Name: contractors contractors_bank_details_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.contractors
    ADD CONSTRAINT contractors_bank_details_key UNIQUE (bank_details);


--
-- Name: contractors contractors_legal_address_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.contractors
    ADD CONSTRAINT contractors_legal_address_key UNIQUE (legal_address);


--
-- Name: contractors contractors_naming_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.contractors
    ADD CONSTRAINT contractors_naming_key UNIQUE (naming);
...
ALTER TABLE ONLY public.contractors
    ADD CONSTRAINT contractors_pkey PRIMARY KEY (identifier);


--
-- Name: users_contractors users_contractors_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.users_contractors
    ADD CONSTRAINT users_contractors_pkey PRIMARY KEY (id);
...
--
-- Name: users_contractors users_contractors_contractor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.users_contractors
    ADD CONSTRAINT users_contractors_contractor_id_fkey FOREIGN KEY (contractor_id) REFERENCES public.contractors(identifier);


--
-- Name: users_contractors users_contractors_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.users_contractors
    ADD CONSTRAINT users_contractors_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);
